        ...
        <AppBar sx={{ backgroundColor: "black" }}>
            <Toolbar>
                ...
                <Box sx={{ marginLeft: "auto" }}>
                    <Button variant="outlined" component={Link} href="/upload_professor" sx={{ color: "gray", borderColor: "gray", marginRight: "25px", transition: "transform 0.2s ease-in-out" ,"&:hover": { borderColor: "gray", transform: "scale(1.2)" } }} >
